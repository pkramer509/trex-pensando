...
#define IONIC_INFO_SZ(_q)	((_q)->num_segs * sizeof(void *))
...
int ionic_mem_setup_bypass(struct ionic_adapter *adapter);
struct rte_mempool *ionic_mem_bypass_mpool(uint32_t socket_id,
	uint32_t seg_sz, struct rte_mempool *base_mp);
#endif
