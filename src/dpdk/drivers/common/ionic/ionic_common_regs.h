...
static inline void
ionic_intr_coal_init(struct ionic_intr __iomem *intr_ctrl DPDK_SIM_UNUSED,
		int intr_idx DPDK_SIM_UNUSED, uint32_t coal DPDK_SIM_UNUSED)
{
#ifndef DPDK_SIM
...
static inline void
ionic_intr_mask(struct ionic_intr __iomem *intr_ctrl DPDK_SIM_UNUSED,
		int intr_idx DPDK_SIM_UNUSED, uint32_t mask DPDK_SIM_UNUSED)
{
#ifndef DPDK_SIM
...
static inline void
ionic_intr_credits(struct ionic_intr __iomem *intr_ctrl DPDK_SIM_UNUSED,
		int intr_idx DPDK_SIM_UNUSED, uint32_t cred DPDK_SIM_UNUSED,
		uint32_t flags DPDK_SIM_UNUSED)
{
#ifndef DPDK_SIM
...
static inline void
ionic_intr_clean(struct ionic_intr __iomem *intr_ctrl DPDK_SIM_UNUSED,
		int intr_idx DPDK_SIM_UNUSED)
{
#ifndef DPDK_SIM
	uint32_t cred;
...
static inline void
ionic_intr_mask_assert(struct ionic_intr __iomem *intr_ctrl DPDK_SIM_UNUSED,
		int intr_idx DPDK_SIM_UNUSED, uint32_t mask DPDK_SIM_UNUSED)
{
#ifndef DPDK_SIM
