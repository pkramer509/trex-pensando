...
#ifdef DPDK_SIM
#define IONIC_DEVCMD_TIMEOUT            60      /* devcmd_timeout */
#else
...
#ifdef DPDK_SIM
#define IONIC_Q_WDOG_MS                 10000   /* 10s */
#define IONIC_Q_WDOG_MAX_MS             50000   /* 50s */
#define IONIC_ADMINQ_WDOG_MS            50000   /* 50s */
#else
